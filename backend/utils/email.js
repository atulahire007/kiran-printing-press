    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f9fafb;">
          ...
          <p style="color: #6b7280; font-size: 14px;">This link expires in 15 minutes. If you didn't request this, please ignore.</p>
        </div>
      </div>
    `,
  }),
    ...
    html: `
      <div style="font-family: Arial, sans-serif; max-width: 600px; margin: 0 auto;">
        ...
        <div style="padding: 30px; background: #f9fafb;">
          ...
          <p>We'll keep you updated on your order status. Estimated delivery: 3-5 business days.</p>
          <p style="color: #6b7280;">Questions? WhatsApp: ${process.env.WHATSAPP_NUMBER}</p>
        </div>
      </div>
    `,
  }),
